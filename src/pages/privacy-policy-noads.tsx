...
export default function PrivacyPolicy(): React.ReactElement {
    return (
        <Layout>
            ...
            <p>
                CodeIterator built the Color Splash - Kids (NO ADS) app as a
                Commercial app. This SERVICE is provided by CodeIterator and is
            ...
            <p>
                ...
                in our Terms and Conditions, which is accessible at Color Splash
                - Kids (NO ADS) unless otherwise defined in this Privacy Policy.
            </p>
            <p>
            ...
            <p>
                ...
                Policy, do not hesitate to contact us at pavelkukov@gmail.com.
            </p>
            <p>
